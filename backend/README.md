...
## Project Structure
    ...
    ├── testapiautosettings_56938  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_56938`
...
2. Clone this repo and `cd testapiautosettings_56938`
